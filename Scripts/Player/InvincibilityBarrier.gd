...
func _physics_process(delta: float) -> void:
	...
	star_angle[0] = fmod(star_angle[0] + 101.25 * player.get_direction_multiplier() * delta * 60, 360) 
	star_angle[1] = fmod(star_angle[1] + 11.25 * player.get_direction_multiplier() * delta * 60, 360)
